  ...
  static async create (client: Client, member: GuildMember, type: string): Promise<Ticket> {
    ...
    if (type === 'report') {
      embedBonus = new EmbedBuilder()
        .setImage('https://media.discordapp.net/attachments/1103004857289416754/1104812702339170337/Capture_decran_2023-05-07_185043.png?width=1440&height=350')
        .setColor('#6cc354')
    } else {
      embedBonus = new EmbedBuilder()
        .setImage('https://media.discordapp.net/attachments/1103004857289416754/1104812711684091974/Capture_decran_2023-05-07_185019.png?width=1440&height=347')
        .setColor('#6cc354')
    }
